...
class MessageLookup extends MessageLookupByLibrary {
  ...
  static m3(battleFieldCells, playerFieldCells) =>
      "Available cells for the shot: ${battleFieldCells}, for opponent: ${playerFieldCells}";
  ...
  static m6(total) =>
      "${Intl.plural(total, zero: '', one: 'You\'ve met ${total} time', other: 'You\'ve met ${total} times')}";

  static m7(wins) =>
      "${Intl.plural(wins, zero: '', one: 'won ${wins} game', other: 'won ${wins} games')}";

  static m8(shipSize, shipsLeft) =>
      "Placing ${shipSize}-deck ship. Ships remaining: ${shipsLeft}";
  ...
  static m12(startTime, duration, enemy, result) =>
      "${startTime} duration: ${duration} enemy: ${enemy} ${result}";

  static m13(gamesCount, wins, defeats) =>
      "${Intl.plural(gamesCount, zero: '', one: '${gamesCount} game played, wins: ${wins}, defeats: ${defeats}', other: '${gamesCount} games played, wins: ${wins}, defeats: ${defeats}')}";

  static m14(language) => "Change language to ${language}";

  static m15(gamesCount) =>
      "${Intl.plural(gamesCount, zero: '', one: 'Last ${gamesCount} game:', other: 'Last ${gamesCount} games:')}";
  ...
  static m19(players, games) =>
      "Players online: ${players}, current games: ${games}";
  ...
  static Map<String, Function> _notInlinedMessages(_) => <String, Function>{
        ...
        "GameI18n_cannotPlaceShip":
            MessageLookupByLibrary.simpleMessage("Can not place ship"),
        "GameI18n_cellsAwailable": m3,
        "GameI18n_confirmShipsPlacement": MessageLookupByLibrary.simpleMessage(
            "Submit placement: 1 - all correct; 2 - set ships again"),
        "GameI18n_doShot":
            MessageLookupByLibrary.simpleMessage("Enter shot coordinates"),
        "GameI18n_enemyDoShot": m4,
        "GameI18n_gameFound": m5,
        "GameI18n_haventMet": MessageLookupByLibrary.simpleMessage(
            "You never met with this opponent"),
        "GameI18n_hit":
            MessageLookupByLibrary.simpleMessage("Hit! Ship is wounded"),
        "GameI18n_howtoPlaceShips": MessageLookupByLibrary.simpleMessage(
            "How to place ships: 1 - manual; 2 - automatically"),
        ...
        "GameI18n_opponentDisconnected": MessageLookupByLibrary.simpleMessage(
            "Lost connection to opponent, awaiting for reconnection..."),
        ...
        "GameI18n_reconnectingToGame": MessageLookupByLibrary.simpleMessage(
            "Reconnecting to current game"),
        "GameI18n_shipOrientation": MessageLookupByLibrary.simpleMessage(
            "Input orientation: 1 - horizontal; 2 - vertical; 0 - place remaining ships automatically"),
        "GameI18n_shipStartPoint": MessageLookupByLibrary.simpleMessage(
            "Enter the coordinate of the beginning of the ship; 0 - place the remaining ships automatically"),
        "GameI18n_shootAgain": MessageLookupByLibrary.simpleMessage(
            "The field has already been shot, repeat the shot"),
        "GameI18n_sunk":
            MessageLookupByLibrary.simpleMessage("Hit! Ship destroyed"),
        ...
        "GameI18n_wrongCoordinates": MessageLookupByLibrary.simpleMessage(
            "Invalid coordinates, repeat input"),
        "OtherI18n_help": MessageLookupByLibrary.simpleMessage(
            "/help - list of available commands\n/pm <name> - private message to player <name>\n/chat - chat in main menu or current game\n/cells - cells available for shooting in the current game\n/language - current language\n/languages - list of available languages\n/language <lang> - select language <lang>"),
        ...
        "PlayerInfoI18n_gameResultDefeat":
            MessageLookupByLibrary.simpleMessage("Defeat"),
        ...
        "ServerI18n_unknownCommand":
            MessageLookupByLibrary.simpleMessage("Unknown command"),
